...
'LBL_PDF_CONFIGURATOR_DESC'=>'ท่านสามารถเปลี่ยนรูปแบบ PDF ของใบแจ้งหนี้ได้',
'LBL_PDF_CONFIGURATOR_FONTS'=>'ฟอนท์เหล่านี้คือที่เลือกใช้ได้ โดยฟอน์ทภาษาไทยคือ "THSaraban".',
'LBL_PDF_CONFIGURATOR_FONTSSIZE'=>'ตรงนี้ท่านสามารถกำหนดขนาดตัวอักษรในแต่ละส่วนได้เป็น pixel (px).',
'LBL_PDF_CONFIGURATOR_FONTSSIZE_HEADER'=>'ส่วนหัว',
'LBL_PDF_CONFIGURATOR_FONTSSIZE_FOOTER'=>'ส่วนท้าย',
'LBL_PDF_CONFIGURATOR_FONTSSIZE_ADDRESS'=>'ที่อยู่',
'LBL_PDF_CONFIGURATOR_FONTSSIZE_BODY'=>'บอดี้',
