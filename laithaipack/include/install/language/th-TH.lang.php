...
$optionalModuleStrings = array(
	...
	'Thai_description' => 'Thai Language pack ',
	'PDFSettings_description' => 'PDF Settings add on TCPDF support UTF8 Font',
);

$installationStrings = array(
	'LBL_VTIGER_CRM_5' => 'vtiger CRM 5 ภาษาไทย',
	'LBL_CONFIG_WIZARD' => 'ตัวช่วยเหลือในการติดตั้ง',
	'LBL_WELCOME' => 'ยินดีต้อนรับ',
	'LBL_WELCOME_CONFIG_WIZARD' => 'ยินดีต้อนรับเข้าสู่การติดตั้ง',
	'LBL_ABOUT_CONFIG_WIZARD' => 'นี่คือตัวช่วยเหลือในการติดตั้ง vtiger CRM ',
	'LBL_ABOUT_VTIGER' => 'vtiger CRM เป็นโครงการโอเพนซอร์ส ที่ขับเคลื่อนด้วยคอมมูนิตี้ จากทั่วโลก<br /><br />
							เป้าหมายของโครงการคือการให้โซลูชั่น CRM ที่ดีที่สุดกับค่าใช้จ่ายรวมต่ำสุด ให้กับกิจการในแต่ละขนาด ตั้งแต่ขนาดเล็ก ไปจนถึงขนาดใหญ่ <br /><br /> 
							โครงการนี้ได้รับความสนใจ และมีผู้ดาวน์โหลดมากกว่าหนึ่งพันครั้งต่อวัน <br /><br />
							vtiger CRM มีชุมชนนักพัฒนาและผู้ใช้งานกับผู้ร่วมกันจากหลายประเทศ ซึ่งทำให้รองรับภาษาต่างๆ <br /><br />
							ภาษาไทยที่ท่านใช้อยู่นี้ สมาคมศึกษาและพัฒนาโอเพ่นซอร์ส OSEDA.or.th ได้ร่วมพัฒนาออกมาแจกจ่าย ซึ่งท่านสามารถร่วมสนับสนุนเพื่อให้การพัฒนาสมบูรณ์ขึ้นได้ด้วยเช่นกัน',
	'LBL_INSTALL' => 'ติดตั้ง',
	'LBL_MIGRATE' => 'ไมเกรด',
	'ERR_RESTRICTED_FILE_ACCESS' => 'Sorry! Attempt to access restricted file',
	'LBL_INSTALLATION_CHECK' => 'ตรวจสอบ การติดตั้ง',
	'LBL_BACK' => 'ย้อนกลับ',
	'LBL_NEXT' => 'ต่อไป',
	'LBL_AGREE' => 'ยอมรับ',
	'LBL_SYSTEM_CONFIGURATION'=> 'ตั้งค่าระบบ',
	'LBL_INSTALLATION_CHECK' => 'Installation Check',
	'LBL_PRE_INSTALLATION_CHECK' => 'ตรวจสอบ ก่อนทำการติดตั้ง',
	'LBL_CHECK_AGAIN' => 'ตรวจสอบ อีกครั้ง',
	'LBL_CONFIRM_SETTINGS' => 'Confirm Settings',
	'LBL_CONFIRM_CONFIG_SETTINGS' => 'ยืนยัน ข้อมูลที่กำหนด',
	...
	'LBL_PHP_VERSION_GT_5' => 'PHP เวอร์ชั่น >= 5.0',
	'LBL_YES' => 'Yes',
	'LBL_NO' => 'No',
	...
	'LBL_RECOMMENDED_PHP_SETTINGS' => 'ค่าแนะนำในการตั้งค่า PHP ',
	'LBL_DIRECTIVE' => 'Directive',
	'LBL_RECOMMENDED' => 'แนะนำ',
	...
	'LBL_CHANGE' => 'เปลี่ยน',
	'LBL_DATABASE_INFORMATION' => 'รายละเอียด ฐานข้อมูล',
	'LBL_CRM_CONFIGURATION' => 'กำหนดค่าการใช้งาน CRM ',
	'LBL_USER_CONFIGURATION' => 'กำหนดค่าผู้ใช้งาน',
	'LBL_DATABASE_TYPE' => 'ประเภท ฐานข้อมูล',
	'LBL_NO_DATABASE_SUPPORT' => 'No database support detected',
	'LBL_HOST_NAME' => 'ชื่อโฮส',
	'LBL_USER_NAME' => 'ชื่อผู้ใช้',
	'LBL_PASSWORD' => 'รหัสผ่าน',
	'LBL_DATABASE_NAME' => 'ชื่อฐานข้อมูล',
	'LBL_CREATE_DATABASE' => 'สร้างฐานข้อมูล',
	'LBL_DROP_IF_EXISTS' => 'จะลบข้อมูลหากมีชื่อนี้อยู่แล้ว',
	'LBL_ROOT' => 'Root',
	'LBL_UTF8_SUPPORT' => 'UTF-8 Support',
	'LBL_URL' => 'URL',
	'LBL_CURRENCY_NAME' => 'สกุลเงินที่ใช้',
	'LBL_USERNAME' => 'ชื่อผู้ใช้งาน',
	'LBL_EMAIL' => 'อีเมล',
	'LBL_POPULATE_DEMO_DATA' => 'ทำการติดตั้ง ข้อมูลตัวอย่าง',
	'LBL_DATABASE' => 'ฐานข้อมูล',
	...
	'LBL_DATABASE_CONFIGURATION' => 'รายละเอียดฐานข้อมูล',
	'LBL_ENABLED' => 'Enabled',
	'LBL_NOT_ENABLED' => 'Not Enabled',
	'LBL_SITE_CONFIGURATION' => 'รายละเอียดการใช้งานเว็บไซต์',
	...
	'ERR_UNABLE_CREATE_DATABASE' => 'ไม่สามารถสร้างฐานข้อมูลได้',
	...
	'LBL_DEMO_DATA_IN_PROGRESS' => 'กำลังติดตั้งข้อมูลตัวอย่าง..',
	'LBL_PLEASE_WAIT' => 'กรุณารอสักครู่...',
	'LBL_ALL_SET_TO_GO' => 'is all set to go!',
	'LBL_INSTALL_PHP_FILE_RENAMED' => 'ไฟล์ install.php ของคุณ ถูกเปลี่ยนชื่อเป็น',
	'LBL_MIGRATE_PHP_FILE_RENAMED' => 'ไฟล์ migrate.php ของคุณ ถูกเปลี่ยนชื่อเป็น',
	'LBL_INSTALL_DIRECTORY_RENAMED' => 'โฟลเดอร์ install ของคุณ ถูกเปลี่ยนชื่อเป็น',
	'WARNING_RENAME_INSTALL_PHP_FILE' => 'คุณจะต้องทำการเปลี่ยนชื่อไฟล์  install.php',
	'WARNING_RENAME_MIGRATE_PHP_FILE' => 'คุณจะต้องทำการเปลี่ยนชื่อไฟล์ migrate.php ',
	'WARNING_RENAME_INSTALL_DIRECTORY' => 'คุณจะต้องทำการเปลี่ยนชื่อโฟลเดอร์ install ',
	'LBL_LOGIN_USING_ADMIN' => 'กรุณาทำการเข้าใช้งานด้วยชื่อผู้ใช้ "admin" และใช้รหัสผ่านที่คุณได้กำหนดไว้ในขั้นตอน 3',
